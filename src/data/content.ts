...
export const testimonials: Testimonial[] = [
  {
    ...
    quote:
      'We replaced a 14-person tier-1 team with Servicios AI and CSAT actually went up six points. The thing genuinely sounds like our brand.',
    rating: 5,
  },
  {
    id: '2',
  ...
  },
  {
    ...
    quote:
      'We evaluated nine platforms.Servicios AI was the only one that didn\'t hallucinate on our compliance docs. That ended the search.',
    rating: 5,
  },
  {
    id: '5',
...
export const faqs: FAQ[] = [
  ...
  {
    question: 'Can I self-host Servicios AI?',
    answer:
