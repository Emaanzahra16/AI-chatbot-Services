...
// import { Slot } from '@radix-ui/react-slot'; // Comment this out
...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  asChild?: boolean; // Keep this but it won't do anything
}
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  // Always use 'button' - ignore asChild
  const Comp = 'button';
