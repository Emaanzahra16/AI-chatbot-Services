    ...
    <div className="relative min-h-screen bg-ink-950 pt-32 pb-20">
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-500/5 to-violet-500/5 p-6 backdrop-blur">
            ...
            <div className="space-y-3 text-sm">
              <InfoRow icon={Building} label="Razón Social" value="Servicios AI Solutions SL" />
              <InfoRow icon={Mail} label="Domicilio" value="Calle Ejemplo 123, 08001 Barcelona, España" />
              <InfoRow icon={FileText} label="NIF / CIF" value="B-12345678" />
              <InfoRow icon={Mail} label="Correo Electrónico" value="legal@servicios.ai" />
              <InfoRow icon={Phone} label="Teléfono" value="+34 624 280 211" />
              <InfoRow icon={Building} label="Registro Mercantil" value="Barcelona, Tomo 12345, Folio 123, Sección 8, Hoja M-123456" />
              <InfoRow icon={Globe} label="Dominio" value="Servicios.ai" />
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="space-y-3 text-sm text-ink-300">
              ...
              <div className="mt-3 space-y-2">
                <p><strong className="text-white">Company Name:</strong> Servicios AI Solutions SL</p>
                <p><strong className="text-white">Registered Address:</strong> Calle Ejemplo 123, 28001 Barcelona, Spain</p>
                <p><strong className="text-white">Tax ID (NIF/CIF):</strong> B-12345678</p>
                <p><strong className="text-white">Email:</strong> legal@servicios.ai</p>
                <p><strong className="text-white">Phone:</strong> +34 624 280 211</p>
                <p><strong className="text-white">Commercial Registry:</strong> Barcelona, Volume 12345, Folio 123, Section 8, Page M-123456</p>
              </div>
            </div>
          </div>
            ...
            content={
              <>
                ...
                <p className="text-sm text-ink-300">
                  El presente aviso legal regula el uso del sitio web servicios.ai (en adelante, &quot;el Sitio Web&quot;), 
                  del cual es titular Servicios AI Solutions SL (en adelante, &quot;Servicios AI&quot;). El Sitio Web tiene 
                ...
                <p className="text-sm text-ink-300">
                  This legal notice regulates the use of the website servicios.ai (hereinafter &quot;the Website&quot;), 
                  owned by Servicios AI Solutions SL (hereinafter &quot;Servicios AI&quot;). The Website aims to provide 
            ...
            content={
              <>
                ...
                <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-ink-300">
                  ...
                  <li>Servicios AI se reserva el derecho de modificar unilateralmente el contenido del Sitio Web.</li>
                </ul>
                <p className="mt-3 font-semibold text-cyan-300">English:</p>
                <p className="text-sm text-ink-300">
            ...
            content={
              <>
                ...
                <p className="text-sm text-ink-300">
                  ...
                  son propiedad de Servicios AI o de sus licenciantes y están protegidos por la legislación 
                ...
                <p className="text-sm text-ink-300">
                  ...
                  of Servicios AI or its licensors and is protected by Spanish and international intellectual 
          ...
          <Section
            ...
            content={
              <>
                <p className="font-semibold text-amber-300">Español:</p>
                <p className="text-sm text-ink-300">
                  Servicios AI no garantiza la disponibilidad, continuidad o ausencia de errores en el Sitio Web. 
                ...
                <div className="mt-3 rounded-lg border border-rose-500/20 bg-rose-500/5 p-3">
                  <p className="text-sm text-rose-300">
                    ⚠️ Servicios AI no es responsable de las decisiones tomadas basándose en respuestas generadas por IA.
                  </p>
                </div>
                <p className="mt-3 font-semibold text-cyan-300">English:</p>
                <p className="text-sm text-ink-300">
                  Servicios AI does not guarantee the availability, continuity, or absence of errors on the Website. 
            ...
            content={
              <>
                ...
                <p className="text-sm text-ink-300">
                  ...
                  Servicios AI como responsable del tratamiento. Puede consultar nuestra 
                  <Link href="/privacy" className="mx-1 text-cyan-400 underline">Política de Privacidad</Link> 
                ...
                <p className="text-sm text-ink-300">
                  ...
                  Servicios AI as the data controller. Please see our 
            ...
            content={
              <>
                ...
                <p className="text-sm text-ink-300">
                  ...
                  sometida a los Juzgados y Tribunales de <strong>Barcelona, España</strong>, renunciando las partes 
                ...
                <p className="text-sm text-ink-300">
                  ...
                  of <strong>Barcelona, Spain</strong>, with the parties waiving any other jurisdiction that may apply.
                </p>
              </>
            }
          />
          ...
          <div className="rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-violet-500/5 p-6 backdrop-blur">
            ...
            <div className="mt-3 space-y-2 text-sm">
              <p><strong className="text-white">Email:</strong> <a href="mailto:legal@Servicios.ai" className="text-cyan-400 underline">legal@Servicios.ai</a></p>
              <p><strong className="text-white">Teléfono / Phone:</strong> +34 900 123 456</p>
              <p><strong className="text-white">Dirección / Address:</strong> Calle Ejemplo 123, 08001 Barcelona, España</p>
            </div>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-xs text-ink-400">
          <p>© {currentYear} Servicios AI Solutions SL. Todos los derechos reservados.</p>
          <p className="mt-1">
